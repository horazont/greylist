...
SCHEMA[("index", "whitelist_last_seen")] = """CREATE INDEX last_seen ON greylist (last_seen)"""
SCHEMA[("index", "greylist_last_seen")] = """CREATE INDEX last_seen ON greylist (last_seen)"""
